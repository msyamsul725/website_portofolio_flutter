...
class ProjectTabletA extends StatefulWidget {
  final List<GlobalKey> category;
  final int index;
  final double pixels;
  const ProjectTabletA({
    Key? key,
  ...
  @override
  State<ProjectTabletA> createState() => _ProjectTabletAState();
}

class _ProjectTabletAState extends State<ProjectTabletA> {
  @override
    ...
    return Container(
      ...
      child: Stack(
        ...
        children: [
          ...
          AnimatedPositioned(
            duration: const Duration(milliseconds: 500),
            right: widget.pixels >= 1200 ? 100.0 : 0.0,
            top: 450.0,
