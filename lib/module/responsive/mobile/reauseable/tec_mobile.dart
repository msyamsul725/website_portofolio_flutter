...
class TexhNologiMobile extends StatefulWidget {
  const TexhNologiMobile({Key? key}) : super(key: key);

  @override
  State<TexhNologiMobile> createState() => _TexhNologiMobileState();
}

class _TexhNologiMobileState extends State<TexhNologiMobile> {
  @override
