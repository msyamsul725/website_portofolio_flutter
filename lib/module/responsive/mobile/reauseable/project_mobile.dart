...
class ProjectMobileA extends StatefulWidget {
  final List<GlobalKey> categorias;
  final int index;

  const ProjectMobileA({
    Key? key,
  ...
  @override
  State<ProjectMobileA> createState() => _ProjectMobileAState();
}

class _ProjectMobileAState extends State<ProjectMobileA> {
  @override
